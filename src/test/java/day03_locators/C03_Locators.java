...
3. Sayfada kac tane link oldugunu bulun.
    ...
    public static void main(String[] args) {
      ...
      //         e. Expected user id nin testtechproed@gmail.com oldugunu dogrulayin(verify).
        ...
        //bir web elementin uzerinde ne yazdigini gormek istersek webelement.getText() kullaniriz
      ...
      //         f. “Addresses” ve “Sign Out” textlerinin görüntülendiğini( displayed) doğrulayin(verify).
        ...
        System.out.println("Sayfadaki list sayisi : "+linklerListesi.size());
        //linkleri yazdiralim
        //listemiz web elementlerden olustugu icin direk yazdirirsak referanslari yazdirir onun yerine
        //foreach loop yapip her bir link webelementinin uzerindeki yaziyi yazdirmaliyiz
